...
type KnownHttpHeaders<XHeaders extends string = string> = {
  ...
  'content-type'?: 'text/html' | 'application/json' | 'application/octet-stream' | `${XHeaders}` | XHeaders | undefined;
...
export type HeaderValue<T, XHeaders extends string> = T extends keyof KnownHttpHeaders ? KnownHttpHeaders<XHeaders>[T] : `${XHeaders}` | XHeaders | string;
